...
const PLACEHOLDERS: [&str; 8] = [
    "Объясни эту кодовую базу",
    "Опиши недавние коммиты",
    "Реализуй {функцию}",
    "Найди и исправь баг в @имяфайла",
    "Напиши тесты для @имяфайла",
    "Улучши документацию в @имяфайла",
    "Запусти /review для моих текущих изменений",
    "Используй /skills чтобы увидеть доступные навыки",
];

const SIDE_PLACEHOLDERS: [&str; 3] = [
    "Проверь недавно изменённые функции на совместимость",
