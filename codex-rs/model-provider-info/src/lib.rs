...
const ONLYSQ_PROVIDER_NAME: &str = "OnlySQ";
pub const ONLYSQ_PROVIDER_ID: &str = "onlysq";
pub const ONLYSQ_BASE_URL: &str = "https://api.onlysq.ru/ai/openai";
pub const ONLYSQ_MODELS_URL: &str = "https://api.onlysq.ru/ai/models";
pub const ONLYSQ_API_KEY_ENV_VAR: &str = "ONLYSQ_API_KEY";
...
pub enum WireApi {
    ...
    /// Used by OnlySQ and other OpenAI-compatible providers that do not
    /// implement the proprietary Responses API.
    Chat,
}
...
impl ModelProviderInfo {
    ...
    pub fn create_onlysq_provider() -> ModelProviderInfo {
        ModelProviderInfo {
            name: ONLYSQ_PROVIDER_NAME.into(),
            base_url: Some(ONLYSQ_BASE_URL.into()),
            env_key: Some(ONLYSQ_API_KEY_ENV_VAR.into()),
            env_key_instructions: Some(
                "Get an API key at https://onlysq.ru and run sqagent again.".into(),
            ),
            experimental_bearer_token: None,
            auth: None,
            aws: None,
...
pub fn built_in_model_providers(
    ...
    let onlysq_provider = P::create_onlysq_provider();

    // OnlySQ is bundled as the default provider for SQAgent.
    [
        (ONLYSQ_PROVIDER_ID, onlysq_provider),
